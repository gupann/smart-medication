...
export function AddBottleDialog({ open, onOpenChange }: AddBottleDialogProps) {
          ...
          <div className="space-y-4 py-4">
            <div className="flex items-center justify-center py-8">
              <div className="relative">
                <div className="size-24 rounded-full bg-blue-100 dark:bg-blue-950 flex items-center justify-center">
                  <Wifi className="size-12 text-blue-600 animate-pulse" />
                </div>
            ...
            <div className="p-4 bg-muted rounded-lg space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-mono">MT-A7F2-8K3P</span>
              </div>
              <div className="flex items-center justify-between text-sm">
            ...
            {!isCalibrating ? (
              <>
                <div className="flex items-center justify-center py-6">
                  <div className="size-32 rounded-full bg-purple-100 dark:bg-purple-950 flex items-center justify-center">
                    <Weight className="size-16 text-purple-600" />
                  </div>
                </div>
              ...
              <div className="space-y-4 py-6">
                <div className="flex items-center justify-center">
                  <div className="size-32 rounded-full bg-purple-100 dark:bg-purple-950 flex items-center justify-center">
                    <Weight className="size-16 text-purple-600 animate-pulse" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium">{calibrationProgress}%</span>
                  </div>
          ...
          <div className="space-y-4 py-6">
            <div className="flex items-center justify-center">
              <div className="size-20 rounded-full bg-green-100 dark:bg-green-950 flex items-center justify-center">
                <svg className="size-12 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="text-center space-y-2">
              <h3 className="text-lg">All Set!</h3>
            ...
            <div className="p-4 bg-muted rounded-lg space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">Daily at 8:00 AM</p>
        ...
        <DialogFooter>
          {step === 4 ? (
            ...
            <>
              ...
              <Button onClick={handleNext} disabled={isCalibrating}>
